...
export default function CSUpdate() {
  ...
  // sate: 고객번호 상태 //
  const { customerNumber } = useParams<string>()
  ...
  // function: get nurse list rseponse 처리 함수 //
  ...
  // event handler: 이미지 변경 이베트 처리 함수 //
  ...
  // event handler: 당당자 본인 선택 이벤트 처리 //
          ...
          <div className='modal-box'>
            <div className='modal-top'>
              ...
              <div className='modal-input-box'>
                <input className='modal-input' placeholder='이름을 입력하세요.' value={searchWord} onChange={onSearchWordChangeHandler} onKeyDown={onSearchWordKeydownHandler} />
