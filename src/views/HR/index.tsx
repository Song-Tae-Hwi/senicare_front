...
import GetNurseListResponseDto from 'src/apis/dto/response/nurse/get-nurse-list.response.dto';
    ...
    <div id='hr-wrapper'>
      <div className='top'>
        <div className='top-text'>
          전체 <span className='emphasis'>{totalCount}</span> | 페이지 <span className='emphasis'>{currentPage}/{totalPage}</span>
        </div>
      </div>
      <div className='main'>
        <div className='table'>
